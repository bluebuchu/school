              ...
              <div className="bg-beige rounded-lg p-6 transition-transform duration-300 group-hover:scale-105">
                ...
                <div className="flex justify-center space-x-3">
                  {member.social.instagram && (
                    <a href={member.social.instagram} className="text-softOrange hover:text-calmBrown">
                  ...
                  {member.social.facebook && (
                    <a href={member.social.facebook} className="text-softOrange hover:text-calmBrown">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {member.social.linkedin && (
                    <a href={member.social.linkedin} className="text-softOrange hover:text-calmBrown">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
