...
export default function ContactBoard() {
  ...
  useEffect(() => {
    ...
    const handleStorageChange = (e: StorageEvent) => {
      if (e.key === 'schoolContact' && e.newValue) {
        try {
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-lg p-8 shadow-lg">
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold text-calmBrown mb-4">Contact Information</h3>
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    <svg className="w-5 h-5 text-softOrange flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="pt-6 border-t border-gray-200">
                <h4 className="font-semibold text-lg text-calmBrown mb-4">Follow Us</h4>
                <div className="flex space-x-4">
                  {contact.instagram && contact.instagram !== '#' && (
                    <a 
                      ...
                      className="text-softOrange hover:text-calmBrown transition-colors"
                    >
