...
export default function ContactBoard() {
  const [contact] = useLocalStorage<Contact>('school-contact', defaultContact);
  const [messages, setMessages] = useLocalStorage<Message[]>('school-messages', defaultMessages);
  ...
  const displayContact = mounted ? contact : defaultContact;
  const displayMessages = mounted ? messages : defaultMessages;
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setMessages([newMessage, ...displayMessages]);
            ...
            <div className="bg-white rounded-lg p-8 shadow-lg mb-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">{displayContact.email}</span>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="w-5 h-5 text-softOrange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-gray-700">{displayContact.address}</span>
                </div>
              </div>
              ...
              <div className="mt-6">
                ...
                <div className="flex space-x-4">
                  {displayContact.instagram && (
                    <a href={displayContact.instagram} className="text-softOrange hover:text-calmBrown transition-colors">
                  ...
                  {displayContact.facebook && (
                    <a href={displayContact.facebook} className="text-softOrange hover:text-calmBrown transition-colors">
                      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {displayContact.twitter && (
                    <a href={displayContact.twitter} className="text-softOrange hover:text-calmBrown transition-colors">
                      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
