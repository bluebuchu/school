  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      message: '프로젝트가 정말 멋져요! 계속 응원하겠습니다.',
      isAnonymous: false,
      createdAt: '2024-11-14',
      reply: '따뜻한 응원 감사합니다! 더 열심히 하겠습니다.',
    },
    {
      id: 2,
      name: '익명',
      email: '',
      message: '회의록 공유 기능이 있으면 좋겠어요.',
      isAnonymous: true,
            ...
            <div className="bg-white rounded-lg p-8 shadow-lg mb-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">contact@dasischool.com</span>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="w-5 h-5 text-softOrange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="mt-6">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="text-softOrange hover:text-calmBrown transition-colors">
