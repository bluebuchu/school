            ...
            >
              <div className="bg-beige rounded-lg p-4 md:p-5 lg:p-6 transition-transform duration-300 group-hover:scale-105">
                ...
                <div className="flex justify-center space-x-3">
                  {member.instagram && (
                    <a href={member.instagram} className="text-softOrange hover:text-calmBrown">
                  ...
                  {member.facebook && (
                    <a href={member.facebook} className="text-softOrange hover:text-calmBrown">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {member.linkedin && (
                    <a href={member.linkedin} className="text-softOrange hover:text-calmBrown">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
